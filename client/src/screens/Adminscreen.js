    ...
    <div className="ml-3">
      ...
      {loading ? (
        ...
        <div>
          ...
          <div>
            <Tag color="blue">Users: {userCount}</Tag>
            <Tag color="green">Rooms: {roomCount}</Tag>
            <Tag color="orange">Bookings: {bookingCount}</Tag>
          </div>
        </div>
      )}
